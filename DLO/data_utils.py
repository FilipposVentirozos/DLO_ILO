...
class ABSADataset(Dataset):
    def __init__(self, tokenizer, data_dir, data_type, top_k=100, max_len=128):
        # './data/rest16/train.txt'
        self.data_path = f'/Users/filippos.ventirozos/Library/CloudStorage/OneDrive-AutoTraderGroupPlc/Projects/AspectQuad/data/{data_dir}/{data_type}.txt'
