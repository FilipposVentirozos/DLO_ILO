...
def train_function(args, seed):
    ...
    if args.do_inference:
        ...
        sents, _ = read_line_examples_from_file(f'/Users/filippos.ventirozos/Library/CloudStorage/OneDrive-AutoTraderGroupPlc/Projects/AspectQuad/data/{args.dataset}/test.txt')
